...
![](Pasted%20image%2020221115161256.png)

### 1.1 构建

Java 项目开发过程中，构建指的是使用『**原材料生产产品**』的过程。

![](Pasted%20image%2020221115161326.png)

构建过程主要包含以下环节：

![](Pasted%20image%2020221115161335.png)
...
![](Pasted%20image%2020221115161416.png)

或者你也可以选择之前的版本：

![](Pasted%20image%2020221115161517.png)

然后里面选择自己对应的版本下载即可：

![](Pasted%20image%2020221115161547.png)

下载之后解压到**非中文、没有空格**的目录，如下：

![](Pasted%20image%2020221115161603.png)
...
Maven 是一个用 Java 语言开发的程序，它必须基于 JDK 来运行，需要通过 JAVA\_HOME 来找到 JDK 的安装位置。

![](Pasted%20image%2020221115161616.png)
...
![](Pasted%20image%2020221115161627.png)
...
![](Pasted%20image%2020221115161647.png)
...
![](Pasted%20image%2020221115161657.png)
...
![](Pasted%20image%2020221115161729.png)
...
![](Pasted%20image%2020221115161746.png)

![](Pasted%20image%2020221115161852.png)
...
![](Pasted%20image%2020221115162121.png)

![](Pasted%20image%2020221115161758.png)

![](Pasted%20image%2020221115162139.png)

然后可以再**父工程**的 pom 文件中看到：

![](Pasted%20image%2020221115162147.png)

而**子工程**的 pom 如下：

![](Pasted%20image%2020221115162155.png)
...
![](Pasted%20image%2020221115162211.png)

**⑤ 修改父工程依赖信息的版本**

这个修改可以是降级，也可以是升级，但一般来说都是升级。

![](Pasted%20image%2020221115162228.png)
...
![](Pasted%20image%2020221115162241.png)
...
![](Pasted%20image%2020221115162256.png)
...
![](Pasted%20image%2020221115162322.png)

这里我们可以对接 profile 这个单词中『侧面』这个含义：项目的每一个运行环境，相当于是项目整体的一个侧面。

![](Pasted%20image%2020221115162330.png)
...
![](Pasted%20image%2020221115162345.png)
...
![](Pasted%20image%2020221115162403.png)
...
![](Pasted%20image%2020221115162501.png)
...
![](Pasted%20image%2020221115162511.png)
...
![](Pasted%20image%2020221115162529.png)
...
![](Pasted%20image%2020221115162613.png)

### 7.2 初始设置

点击右上角的登录：

![](Pasted%20image%2020221115162631.png)
...
![](Pasted%20image%2020221115162733.png)
...
![](Pasted%20image%2020221115162745.png)


然后创建仓库，如下：

![](Pasted%20image%2020221115162753.png)

同理创建 releases 仓库，然后查看列表：

![](Pasted%20image%2020221115162804.png)
...
![](Pasted%20image%2020221115162816.png)

然后创建：

![](Pasted%20image%2020221115162830.png)
...
![](Pasted%20image%2020221115162927.png)
...
![](Pasted%20image%2020221115162936.png)

下载后，Nexus 服务器上就有了 jar 包：

![](Pasted%20image%2020221115162945.png)
...
![](Pasted%20image%2020221115162959.png)

#### 7.6.2 上传到 maven-releases

修改项目的版本，如下：

![](Pasted%20image%2020221115163014.png)

执行命令 `mvn deploy`：

![](Pasted%20image%2020221115163023.png)

查看：

![](Pasted%20image%2020221115163029.png)
...
![](Pasted%20image%2020221115163123.png)
...
![](Pasted%20image%2020221115163133.png)
...
![](Pasted%20image%2020221115163144.png)

然后基于 pom.xml 的依赖冲突分析，如下：

![](Pasted%20image%2020221115163156.png)

查看冲突分析结果：

![](Pasted%20image%2020221115163209.png)
...
![](Pasted%20image%2020221115163223.png)
